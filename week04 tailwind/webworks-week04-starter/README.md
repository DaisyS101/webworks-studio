...
### Decision 1
**Used:** `max-w-7xl mx-auto px-6 lg:px-8`  
**Why:** Keeps the content comfortably readable, centered, and padded across narrow and wide viewports. and helps keep the the page stable and not comstantly glitching or moving like I have seen in pages in other sites.

### Decision 2
**Used:** `grid gap-5 md:grid-cols-3`  
**Why:** Stacks the roast cards on small screens and creates a clear three-column comparison when space allows which does help making the site and pages fit to different sizes like phone,tablet or computer.

### Decision 3
**Used:** `focus-visible:ring-2 hover:bg-amber-800`  
